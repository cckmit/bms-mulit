...
public class ExcelUtils {
    ...
    public static void exportTemplateExcel(HttpServletResponse response, String fileName, TemplateExportParams params, Map<String, Object> map) throws IOException {
