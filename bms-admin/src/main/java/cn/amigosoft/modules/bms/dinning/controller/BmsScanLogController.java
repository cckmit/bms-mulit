...
import cn.amigosoft.modules.bms.dinning.excel.BmsScanLogExcel;
...
public class BmsScanLogController {
    ...
    @RequiresPermissions("bms:scanLog:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("bms:scanLog:info")
    ...
    @PostMapping
    @ApiOperation("保存")
    @LogOperation("扫码记录表-保存")
    @RequiresPermissions("bms:scanLog:save")
    public Result save(@RequestBody BmsScanLogDTO dto){
        //效验数据
    ...
    @RequiresPermissions("bms:scanLog:update")
    ...
    @RequiresPermissions("bms:scanLog:delete")
    ...
    @GetMapping("export")
    @ApiOperation("导出")
    @LogOperation("扫码记录表-导出")
    @RequiresPermissions("bms:scanLog:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<BmsScanLogDTO> list = bmsScanLogService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, list, BmsScanLogExcel.class);
    }
