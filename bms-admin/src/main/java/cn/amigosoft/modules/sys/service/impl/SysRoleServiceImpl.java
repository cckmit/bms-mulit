...
import cn.amigosoft.modules.sys.dao.SysRoleDao;
...
public class SysRoleServiceImpl extends BaseServiceImpl<SysRoleDao, SysRoleEntity> implements SysRoleService {
    ...
    private QueryWrapper<SysRoleEntity> getWrapper(Map<String, Object> params) {
        ...
        int permissionFlag = userService.checkUserHavePermission(user.getId(), BmsConstant.PERMISSION_VIEW_ROLE_ALL);
    ...
    public void save(SysRoleDTO dto) {
        ...
        //保存角色小程序菜单关系
        appMenuService.saveOrUpdate(entity.getId(), dto.getAppMenuIdList());
    }
    ...
    public void delete(Long[] ids) {
        ...
        // 删除角色小程序菜单关系
        appMenuService.deleteByRoleIds(ids);
    }

    public List<SysRoleEntity> getRoleName() {
        return this.baseDao.getRoleName();
    }
