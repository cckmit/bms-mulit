...
package cn.amigosoft.utils;

import cn.amigosoft.entity.ColumnEntity;
import cn.amigosoft.entity.TableEntity;
...
//		templates.add("template/postgresql.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        //特殊化前端模板
        if (!config.getBoolean("isAntVue")) {
            templates.add("template/index.vue.vm");
            templates.add("template/add-or-update.vue.vm");
        } else {
            templates.add("template/indexAnt.vue.vm");
            templates.add("template/add-or-updateAnt.vue.vm");
            templates.add("template/detailAnt.vue.vm");
        }
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("indexAnt.vue.vm")) {
            return "vue" + File.separator + "views" + File.separator + "modules" +
                    File.separator + moduleName + File.separator + className.toLowerCase() + ".vue";
        }

        if (template.contains("add-or-updateAnt.vue.vm")) {
            return "vue" + File.separator + "views" + File.separator + "modules" +
                    File.separator + moduleName + File.separator + className.toLowerCase() + "-add-or-update.vue";
        }

        if (template.contains("detailAnt.vue.vm")) {
            return "vue" + File.separator + "views" + File.separator + "modules" +
                    File.separator + moduleName + File.separator + className.toLowerCase() + "-detail.vue";
        }
