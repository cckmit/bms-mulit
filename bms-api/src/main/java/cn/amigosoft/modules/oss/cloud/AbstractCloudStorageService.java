...
public abstract class AbstractCloudStorageService {
     ...
     * @return         返回http地址
     */
    public abstract String uploadSuffix(byte[] data, String suffix, String contentType);
     ...
     * @return             返回http地址
     */
    public abstract String uploadSuffix(InputStream inputStream, String suffix, String contentType);
