...
package cn.amigosoft.modules.security.service.impl;
...
public class ShiroServiceImpl implements ShiroService {
    ...
    @Autowired
    private SysAppMenuDao appMenuDao;
    ...
    public Set<String> getUserPermissions(UserDetail user) {
        ...
        if (user.getSuperAdmin() == SuperAdminEnum.YES.value()) {
            permissionsList = appMenuDao.getAppPermissionsList();
        } else {
            permissionsList = appMenuDao.getUserAppPermissionsList(user.getId());
        }
