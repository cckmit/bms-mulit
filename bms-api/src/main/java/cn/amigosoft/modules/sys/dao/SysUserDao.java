...
public interface SysUserDao extends BaseDao<SysUserEntity> {
    ...
    List<SysUserDTO> selectUserListByPermission(String permission);

    SysUserDTO getUserDetailInfo(@Param("id") Long id);

    List<SysUserDTO> getServiceListByPermission(Map<String, Object> params);

    List<SysUserDTO> getExServiceListByPermission(Map<String, Object> params);
